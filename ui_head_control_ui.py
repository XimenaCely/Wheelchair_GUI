...
################################################################################
## Form generated from reading UI file 'head_control_uiFlQixY.ui'
##
...
class Ui_head_window(object):
    def setupUi(self, head_window):
        if not head_window.objectName():
            head_window.setObjectName(u"head_window")
        head_window.resize(700, 411)
        head_window.setStyleSheet(u"*{\n"
...
"	border-radius: 5px;\n"
"}")
        self.centralwidget = QWidget(head_window)
        ...
        self.start_wizard_btn.setGeometry(QRect(200, 130, 181, 141))
...
"background-color: rgb(66, 66, 66);")
        ...
        head_window.setCentralWidget(self.centralwidget)

        self.retranslateUi(head_window)

        self.stackedWidget.setCurrentIndex(0)


        QMetaObject.connectSlotsByName(head_window)
    # setupUi

    def retranslateUi(self, head_window):
        head_window.setWindowTitle(QCoreApplication.translate("head_window", u"MainWindow", None))
        self.return_btn.setText(QCoreApplication.translate("head_window", u"Main Menu", None))
        self.label.setText("")
        self.main_title.setText(QCoreApplication.translate("head_window", u"<html><head/><body><p><span style=\" color:#ffffff;\">Smart wheelchair</span></p></body></html>", None))
        self.label_2.setText(QCoreApplication.translate("head_window", u"<html><head/><body><p align=\"center\">Welcome to head control!</p><p align=\"center\">You can turn on the system click on the button</p></body></html>", None))
        self.start_wizard_btn.setText("")
        self.label_5.setText(QCoreApplication.translate("head_window", u"<html><head/><body><p align=\"justify\">Please move your head in the direction you want to operate the wheelchair.</p><p align=\"justify\">The image is showing the place you are making pressure in the cup.</p><p align=\"justify\">You also have a scroll bar to change the velocity of the wheelchair in the next page. </p><p align=\"justify\">You have an emergency button to stop the system.</p><p align=\"justify\">To come back and start the controller next page have a return button for that.</p><p align=\"justify\">Let's go to operate the wheelchair!</p></body></html>", None))
        self.nxt.setText("")
        ...
        self.stop_btn.setText(QCoreApplication.translate("head_window", u"Emergency button", None))
        self.prev.setText("")
        self.label_3.setText(QCoreApplication.translate("head_window", u"Change the velocity of the wheelchair", None))
        self.label_4.setText(QCoreApplication.translate("head_window", u"<html><head/><body><p><span style=\" color:#ffffff;\">Version 1.0 Copyright AXGC</span></p></body></html>", None))
