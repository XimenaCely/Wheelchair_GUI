...
serverAddressPortWheelchair   = ("192.168.137.141", 1234)
serverAddressPortNeck   = ("192.168.137.141", 1032)
...
class MainWindow(QMainWindow):
	def __init__(self, parent=None):
		...
		self.ui.minimize_window_button.setIcon(QtGui.QIcon(u"E:\CADEIRA DE RODAS\Desktop_app\icons\minus.svg"))
		self.ui.close_window_button.clicked.connect(lambda: self.close())		
		self.ui.close_window_button.setIcon(QtGui.QIcon(u"E:\CADEIRA DE RODAS\Desktop_app\icons\close.svg"))
		...
		self.ui.home_page_btn.setIcon(QtGui.QIcon(u"E:\CADEIRA DE RODAS\Desktop_app\icons\home.svg"))
		self.ui.system_page_btn.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.system_page))
		self.ui.system_page_btn.setIcon(QtGui.QIcon(u"E:\CADEIRA DE RODAS\Desktop_app\icons\monitor.svg"))
		self.ui.battery_page_btn.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.battery_page))
		self.ui.battery_page_btn.setIcon(QtGui.QIcon(u"E:\CADEIRA DE RODAS\Desktop_app\icons\icons8-battery-unknown-50"))
		self.ui.sensors_page_btn.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.sensors_page))
		self.ui.sensors_page_btn.setIcon(QtGui.QIcon(u"E:\CADEIRA DE RODAS\Desktop_app\icons\icons8-proximity-sensor-30.png"))
		self.ui.networks_page_btn.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.networks_page))
		self.ui.networks_page_btn.setIcon(QtGui.QIcon(u"E:\CADEIRA DE RODAS\Desktop_app\icons\icons8-signal-16.png"))
		self.ui.settings_page_btn.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.settings_page))
		self.ui.settings_page_btn.setIcon(QtGui.QIcon(u"E:\CADEIRA DE RODAS\Desktop_app\icons\settings.svg"))
		self.ui.exit_page_btn.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.exit_page))
		self.ui.exit_page_btn.setIcon(QtGui.QIcon(u"E:\CADEIRA DE RODAS\Desktop_app\icons\log-out.svg"))		
		#movement		
		def moveWindow(e):
		...
		self.ui.open_close_side_bar_btn.setIcon(QtGui.QIcon(u"E:\CADEIRA DE RODAS\Desktop_app\icons\menu.svg"))		
		...
		self.ui.posture_monitoring_btn.setIcon(QtGui.QIcon(u"E:\CADEIRA DE RODAS\Desktop_app\icons\posture2.png"))	
		self.ui.posture_monitoring_btn.clicked.connect(lambda: self.close())
			
		#Threads_PC_battery
		self.threadpool = QtCore.QThreadPool()
		self.psutil_thread()
		#self.ui.close_window_button.clicked.connect(lambda: self.closeThreads())
		
		self.show()
	
	def closeThreads(self,event):
		print('trying to stop threads')
		app.aboutToQuit.connect(self.closeEvent)
		print('stopped threads')
		
	def WiFi_connection(self,progress_callback):
		UDPClientSocket = socket.socket(family=socket.AF_INET, type=socket.SOCK_DGRAM)	
		UDPClientSocket.sendto(bytesToSend, serverAddressPortWheelchair)
		while True:
			...
			print(msg)
			self.ui.close_window_button.clicked.connect(lambda: UDPClientSocket.close())
	...
	def psutil_thread(self):
		...
		wifi_worker= Worker(self.WiFi_connection)
		wifi_worker.signals.result.connect(self.print_output)
		wifi_worker.signals.finished.connect(self.thread_complete)
		wifi_worker.signals.progress.connect(self.progress_fn)
		self.threadpool.start(wifi_worker)
